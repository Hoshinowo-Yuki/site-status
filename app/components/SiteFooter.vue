  ...
  <footer id="footer">
    ...
    <n-flex :size="4" class="text" align="center" vertical>
      ...
      <n-p depth="3">
        ...
        <n-text depth="3" @click="jumpLink(linkData.home)"> IMSYY & Hoshinowo-Yuki </n-text>
        <n-text
          v-if="siteIcp"
          depth="3"
...
const linkData = {
  github: "https://github.com/Hoshinowo-Yuki/site-status",
  home: "https://moe.lolicon.io",
  email: "mailto:hi@lolicon.io",
};
</script>
